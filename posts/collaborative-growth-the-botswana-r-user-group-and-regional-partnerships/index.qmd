...
description: "Last year, Edson Kambeu, founder and organizer of the Botswana R User Group, shared his plans with the R Consortium to implement data into local businesses in the New R Community in Botswana Wants to Implement Data Into Local Businesses."
author: "R Consortium"
image: "media.png"
date: "05/24/2024"
---

Last year, [Edson Kambeu](https://www.linkedin.com/in/edson-kambeu-88657037/?originalSubdomain=bw), founder and organizer of the [Botswana R User Group](https://www.meetup.com/botswana-r-users/), shared his plans with the R Consortium to implement data into local businesses in the [New R Community in Botswana Wants to Implement Data Into Local Businesses](https://www.r-consortium.org/blog/2022/06/16/new-r-community-in-botswana). He recently updated the R Consortium about the group’s growth and recent activities. The group has attracted a global audience through its online events and actively collaborates with R User Groups in the region.
...
_How has your group been doing since we last talked? _
...
Participants attending an online meetup hosted by Botswana R users in collaboration with [Estwatini R Users](https://www.meetup.com/eswatiniuser/) and [Bulawayo R](https://www.meetup.com/bulawayo-r-user-group/)
...
![](media%20(3).png)
[Vebash Naidoo](https://www.linkedin.com/in/vebashini-naidoo-4260a96a/?originalSubdomain=za) of RLadies Jozi presenting in an online meetup for Botswana R Users 

_You have a Meetup titled “[GIS and Creating Dashboards in R. A case study of conflicts events in Kenya](https://www.meetup.com/botswana-r-users/events/298287992/),” can you share more on the topic covered? Why this topic? _
...
_How has the use of R evolved in the industry since we last talked?_
...
_Please share about a project you are working on or have worked on using the R language. What is the goal/reason, result, or anything interesting, especially related to the industry you work in?_
...
_What trends do you currently see in R language and your industry? Any trends you see developing in the near future?_
