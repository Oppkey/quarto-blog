...
<section id="hero">
    <h2 id="scroll-to-hero">R Consortium</h2>
...
<button class="darkButton"><a href="about/about.qmd" style="text-decoration: none;">LEARN MORE</a></button>
...
<button class="joiningRButton"><a href="join.qmd" style="text-decoration: none;">LEARN MORE ABOUT MEMBERSHIP</a></button>
