...
<section class="what-is-r-section">
  ...
  <div style="flex: 1; min-width: 300px; padding: 20px; border">
  <iframe style="width: 100%; height: 100%; border-radius: 15px; overflow: hidden;"  src="https://www.youtube.com/embed/XcBLEVknqvY" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
  </div>
  </div>
