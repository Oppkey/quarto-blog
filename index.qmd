...
<div class="swiper-slide" style="background-image: url(images/carousel/rcon_member_bg1.webp);">
...
<div class="swiper-slide" style="background-image: url(https://imagesupload.xyz/ib/gmnbsRUepr3KshC_1723143844.webp);">
<h2>R Consortium: Supporting the R community, the R Foundation and organizations developing, maintaining and distributing R software.</h2>
</div>
<div class="swiper-slide" style="background-image: url(images/carousel/rcon_slide_bg2b.webp);">
<h2>R User Group Program and Small Conference Funding Program now accepting applications Partner with us to support your meetup or local event.</h2>
</div>
<div class="swiper-slide" style="background-image: url(images/carousel/IMG_5390-1024x716-1.webp);">
